...
public class Pet : SoftDeletableEntity<PetId>
{
    ...
    {
        Photo? candidatePhoto = _photos.FirstOrDefault(p => p == photo);
    ...
    {
        Result<Position, Error> newPosition = Position.Forward();
    ...
    {
        Result<Position, Error> newPosition = Position.Backward();
        if (newPosition.IsFailure)
        {
            return newPosition.Error;
        }
    ...
    public void UpdateHelpStatus(HelpStatus helpStatus) => HelpStatus = helpStatus;
}